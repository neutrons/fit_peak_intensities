...
class IkedaCarpenterConvoluted(IFunction1D):
    def init(self):
        ...
        '''
        self.setConstraintPenaltyFactor("A", 1.0e99)
        self.setConstraintPenaltyFactor("B", 1.0e99)
        self.setConstraintPenaltyFactor("R", 1.0e99)
        self.setConstraintPenaltyFactor("T0", 1.0e99)
        self.setConstraintPenaltyFactor("scale", 1.0e99)
        self.setConstraintPenaltyFactor("hatWidth", 1.0e99)
        self.setConstraintPenaltyFactor("k_conv", 1.0e99)
        '''
